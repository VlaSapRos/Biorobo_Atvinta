<template>
    <button 
        class="checkbox"
        v-bind:class='{ active:( flags.processor[number-1] ) }'
    ...
    >
        <svg class='fillGray' v-bind:class='{fillWhite:+stockroom.processors>=+number, fillOrange:(flags.processor[number-1] && +stockroom.processors>=+number), }' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
